/**
 * Unit tests for POST /api/print/adhoc-load. ecsWsCall is mocked.
 */

jest.mock("../../../lib/ecsWebSocket", () => ({ ecsWsCall: jest.fn() }));

import type { NextApiRequest, NextApiResponse } from "next";
import handler from "../../../pages/api/print/adhoc-load";
...
const item = { productCode: "123", description: "Milk", productTypeCode: "A", sellUnitId: "", qty: 1 };

describe("POST /api/print/adhoc-load", () => {
  beforeEach(() => {
    wsCall.mockReset();
